...
* [Sublime Text + R-Box](http://github.com/randy3k/R-Box/) - R-Box (formerly Enhanced-R) is an add-on package for Sublime Text 2/3 that plays nicely with R.app, Rstudio, iTerm, Terminal and others.
