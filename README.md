...
* [Deep Learning with R, Second Edition](https://www.manning.com/books/deep-learning-with-r-second-edition) - A book about deep learning from the ground up using R and the powerful Keras library.
